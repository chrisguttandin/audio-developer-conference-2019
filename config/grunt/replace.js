                ...
                patterns: [
                    {
                        ...
                        replacement: (_, filename, extension) =>
                            grunt.file.expand({ cwd: 'build/audio-developer-conference-2019', ext: extension }, `assets/${filename}.*`)[0]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/audio-developer-conference-2019${filename}": "${computeHashOfFile(
                                `build/audio-developer-conference-2019${filename}`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/audio-developer-conference-2019/${filename}.html": "${computeHashOfFile(
                                `build/audio-developer-conference-2019/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
                        ...
                        replacement: (match, filename, moduleAttribute, initialHash) => {
                            const updatedHash = /main(?:-es(?:2015|5))?\.[\da-z]+\.js/.test(filename)
                                ? `sha384-${computeHashOfFile(
                                      `build/audio-developer-conference-2019/scripts/${filename}`,
                                      'sha384',
                                      'base64'
                                  )}`
                                : initialHash;
                ...
                patterns: [
                    {
                        ...
                        replacement: (match, filename) => {
                            const hash = `sha384-${computeHashOfFile(
                                `build/audio-developer-conference-2019/styles/${filename}`,
                                'sha384',
                                'base64'
                            )}`;
