module.exports = (grunt) => {
    ...
    return {
        ...
        'prerender': {
            cmd: `npx ng run audio-developer-conference-2019:server:production && \
                npx angular-prerender \
                    --browser-target audio-developer-conference-2019:build \
                    --preserve-index-html \
                    --server-target audio-developer-conference-2019:server`
        },
        'preview': {
